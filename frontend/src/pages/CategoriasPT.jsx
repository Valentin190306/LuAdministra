...
import styles from './CategoriasPT.module.css';

const emptyForm = { nombre: '', categoriaPadreId: '' };

export default function CategoriasPT() {
  const { data, loading, error, refetch } = useApi('/categorias-productos-terminados');
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      if (editing) {
        await api.put(`/categorias-productos-terminados/${editing.id}`, body);
      } else {
        await api.post('/categorias-productos-terminados', body);
      }
      setModalOpen(false);
      refetch();
    } catch (err) {
  ...
  async function handleDelete() {
    ...
    try {
      await api.delete(`/categorias-productos-terminados/${deleteTarget.id}`);
    ...
    <div>
      <div className={styles.header}>
        ...
        <div className={styles.headerActions}>
          ...
          ], 'categorias-productos-terminados.csv')}>Exportar CSV</Button>
